...
export function updateProgress(state,question,result){
 ...
 return{...state,notions:{...state.notions,[id]:next},history:[...(state.history||[]),{at:new Date(now).toISOString(),questionId:question.id,notionId:id,chapterId:question.chapterId,difficulty:question.difficulty,result}].slice(-1000)};
}
