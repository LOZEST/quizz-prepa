...
const cases=[
 {angle:'\\pi - x',cos:'-\\cos x',sin:'\\sin x',sym:'symétrie par rapport à l’axe des ordonnées'},
 {angle:'\\pi + x',cos:'-\\cos x',sin:'-\\sin x',sym:'symétrie centrale par rapport à l’origine'},
 {angle:'\\dfrac{\\pi}{2} - x',cos:'\\sin x',sin:'\\cos x',sym:'échange des coordonnées dans le premier quadrant'},
