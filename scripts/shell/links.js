export const INTERNAL_PAGES=Object.freeze(['index.html','plan.html','session.html','quiz.html','questions.html','stats.html','settings.html','team.html']);
...
export function requestedPage(search=location.search){return safePage(new URLSearchParams(search).get('next'),'quiz.html')}
